  ...
  return(
    ...
    >
      <div className="vh-10 w-full flex flex-row justify-center items-center bg-igo-300 mb-4">
        <Image width={24} height={24} src={'/svg/dental/004-braces.svg'} />
        <h2 className="md:text-2xl text-xl text-white flex font-extrabold ml-2 flex-row justify-center ">Aparelho</h2>
      </div>
      <div>
        <h2 className="text-4xl font-medium text-gray-800 mb-2">Tipos</h2>
        ...
        <h2 className="text-4xl font-medium text-gray-800 mb-2">Tratamento</h2>
        <p className="text-gray-700 mb-5">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsum has been the industry's standard dummy text
          ever since the 1500s, when an unknown printer took a galley of type
